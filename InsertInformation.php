	 ...
	 <div class="content">
		 ...
		 <div class="company">
			 ...
			 <div class="company_details">
				 <h4>Nickname <span> <?php echo ""; ?></span></h4>
				 <h4>Age <span> <?php echo ""; ?></span></h4>
				 <h4>Birthday <span> <?php echo ""; ?></span></h4>
				 <h4>Zodiac <span> <?php echo ""; ?></span></h4>
				 <h4>Ambition <span> <?php echo ""; ?></span></h4>
			 </div>
		 </div>
		 <div class="skills">
			 <h3 class="clr2">FAVORITES</h3>
			 <div class="company_details">
				 <h4>Movies <span> <?php echo ""; ?></span></h4>
				 <h4>Subject <span> <?php echo ""; ?></span></h4>
				 <h4>Singer <span> <?php echo ""; ?></span></h4>
				 <h4>Songs <span> <?php echo ""; ?></span></h4>
				 <h4>Actor <span> <?php echo ""; ?></span></h4>
				 <h4>Actress <span> <?php echo ""; ?></span></h4>
				 <h4>Color <span> <?php echo ""; ?></span></h4>
				 <h4>Book <span> <?php echo ""; ?></span></h4>
				 <h4>TV <span> <?php echo ""; ?></span></h4>
				 <h4>Food <span> <?php echo ""; ?></span></h4>
				 <h4>Cartoon <span> <?php echo ""; ?></span></h4>
				 <h4>Sport <span> <?php echo ""; ?></span></h4>
			 </div>
		 </div>
		  <div class="company">
			 <h3 class="clr1">HEART TO HEART</h3>
			 <div class="company_details">
				 <h4>Describe yourself. <span> <?php echo ""; ?></span></h4>
				 <h4>Who is your crush? <span> <?php echo ""; ?></span></h4>
				 <h4>What is your biggest regret? <span> <?php echo ""; ?></span></h4>
				 <h4>Motto in life. <span> <?php echo ""; ?></span></h4>
				 <h4>Hobbies/Interest <span> <?php echo ""; ?></span></h4>
				 <div class="send">
